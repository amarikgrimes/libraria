...
class AddAuthor(Toplevel):
    def __init__(self, master=None):
        ...
        # Heading
        heading = Label(self.topFrame, text='Add Author', font=('Arial', 20), bg='white', fg='pink')
        ...
        # Add Book Button
        self.button = Button(self.bottomFrame, text='Add Author', font=('Arial', 15),
                             command=self.add_author, bg='pink', fg='white')
